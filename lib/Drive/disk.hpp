...
class Disk {
    protected:
        ...
        std::expected<void, win_error> _get_mbr(HANDLE h);
        std::expected<void, win_error> _get_gpt(HANDLE h);
        std::expected<void, win_error> _get_info_using_ioctl(HANDLE h);
        std::expected<void, win_error> _get_volumes(HANDLE h);
